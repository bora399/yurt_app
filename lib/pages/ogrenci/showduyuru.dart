...
showDuyuru(BuildContext context) {
  ...
  AlertDialog alert = AlertDialog(
    title: const Align(alignment: Alignment.center, child: Text("Duyuru")),
      ...
      return FutureBuilder<DocumentSnapshot>(
          ...
          builder:
            ...
            if (snapshot.connectionState == ConnectionState.done) {
              ...
              return AlertDialog(
                title: const Align(
                    alignment: Alignment.center, child: Text("Duyuru")),
                content: Text(data["duyuru"],
                    style: textThemeDefault.bodyText1!
                        .copyWith(fontSize: 18, color: colorBlack)),
                actions: [
                  TextButton(
